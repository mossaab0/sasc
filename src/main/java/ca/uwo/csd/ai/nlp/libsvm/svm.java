...
public class svm {
    ...
    public static void svm_save_model(String model_file_name, svm_model model) throws IOException {
        try (ObjectOutputStream oStream = new ObjectOutputStream(new FileOutputStream(model_file_name))) {
    ...
    public static svm_model svm_load_model(InputStream is) throws IOException, ClassNotFoundException {
